...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if(mNewPartySizeEditText.getText() == null || mNewGuestEditText.getText() == null){
            return;
        }
        else if(mNewPartySizeEditText.equals("") || mNewGuestEditText.equals("")){
            return;
        }
        ...
        addGuest(mNewGuestEditText.getText().toString(), partySize);
